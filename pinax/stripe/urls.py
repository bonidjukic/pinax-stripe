...
urlpatterns = [
    ...
    url(r"^subscriptions/(?P<pk>[a-zA-Z0-9]+)/delete/$", SubscriptionDeleteView.as_view(), name="pinax_stripe_subscription_delete"),
    url(r"^subscriptions/(?P<pk>[a-zA-Z0-9]+)/update/$", SubscriptionUpdateView.as_view(), name="pinax_stripe_subscription_update"),
    ...
    url(r"^payment-methods/(?P<pk>[a-zA-Z0-9]+)/delete/$", PaymentMethodDeleteView.as_view(), name="pinax_stripe_payment_method_delete"),
    url(r"^payment-methods/(?P<pk>[a-zA-Z0-9]+)/update/$", PaymentMethodUpdateView.as_view(), name="pinax_stripe_payment_method_update"),
